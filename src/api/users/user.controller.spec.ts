...
describe('UserController', () => {
  ...
  it('should be load User by Id', async () => {
    try {
      const result: any = await controller.getUserByid(
        '6371f0e2c1026a4fa70c44e3',
        res,
      );
    ...
    it('should Forgot Password called', async () => {
      try {
        await controller.forgotPassword(
          { toemail: userData.email, message: 'Your reset password otp is' },
          res,
        );
    ...
    it('should otp verification called', async () => {
      try {
        await controller.otpVerification(
          { toemail: userData.email, otp: userData.otp },
          res,
        );
    ...
    it('should reset password', async () => {
      try {
        await controller.resetPassword(
          { toemail: userData.email, password: userData.password },
          res,
        );
